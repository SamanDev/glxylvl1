    ...
    return (
        <span className="myaccount popupmenu">
            <span className="lazyarea">
                        ...
                        <List.Content className="rtl text-center">
                            <GiftsDesc
                                desc={
                                    <>
                                        <div style={{ float: "right", margin: "0 10px" }}>
                                            <LevelIcon mode="gift3" level="1" text="Gold Gift" classinside="iconinside0" number="1" width="60px" amin="inline animated swing fast" iconamin="swing inline animated" />
                                        </div>
                                        <div
                                            style={{
                                                height: 80,
                                ...
                                subtitle={
                                    <>
                                        <br />
                                        از <span className="text-gold">{doCurrency(levelDataInfo[4].minAmount)}</span> تا <span className="text-gold">{doCurrency(levelDataInfo[4].maxAmount)}</span>
                                    </>
                                }
                                title={<>هدیه طلایی</>}
                            />
                            <GiftsDesc
                                desc={
                                    <>
                                        <div style={{ float: "right", margin: "0 10px" }}>
                                            <LevelIcon mode="gift2" level="1" text="Purple Gift" classinside="iconinside0" number="1" width="60px" amin="inline animated swing fast" iconamin="swing inline animated" />
                                        </div>
                                        <div
                                            style={{
                                                height: 80,
                                        ...
                                        >
                                            مخصوص بازیکنان
                                            <br /> لول {levelDataInfo[5].minLevel} تا {levelDataInfo[5].maxLevel}
                                        </div>
                                    </>
                                }
                                subtitle={
                                    <>
                                        <br />
                                        از <span className="text-gold">{doCurrency(levelDataInfo[5].minAmount)}</span> تا <span className="text-gold">{doCurrency(levelDataInfo[5].maxAmount)}</span>
                                    </>
                                }
                                title={<>هدیه بنفش</>}
                            />
                            <GiftsDesc
                                desc={
                                    <>
                                        <div style={{ float: "right", margin: "0 10px" }}>
                                            <LevelIcon mode="gift1" level="1" text="Red Gift" classinside="iconinside0" number="1" width="60px" amin="inline animated swing fast" iconamin="swing inline animated" />
                                        </div>
                                        <div
                                            style={{
                                                height: 80,
                                ...
                                subtitle={
                                    <>
                                        <br />
                                        از <span className="text-gold">{doCurrency(levelDataInfo[6].minAmount)}</span> تا <span className="text-gold">{doCurrency(levelDataInfo[6].maxAmount)}</span>
                                    </>
                                }
                                title={<>هدیه قرمز</>}
                            />
                ...
                {loginToken?.accessToken && !loginToken?.logout && loginToken?.refer != "Runner" && loginToken?.refer != "bots" && (
                    <LazyLoad height={300}>
